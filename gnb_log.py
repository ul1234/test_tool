    ...
    def extract_sib19_req(self, xml_file):
        ...
        if config is not None:
            for index in config.findall("INDEX"):
                ...
                line = f"epoch_sfn: {epoch_sfn:>9}, epoch_sf: {epoch_sf:>4}, ul_valid_duration: {ul_valid_duration:>5}, k_offset_cell: {k_offset_cell:>5}, ta_common: {ta_common:>9}, ta_common_drift: {ta_common_drift:>4}, ta_common_drift_variant: {ta_common_drift_variant:>2}, position_x: {position_x:>10}, position_y: {position_y:>10}, position_z: {position_z:>10}, velocity_x: {velocity_x:>10}, velocity_y: {velocity_y:>10}, velocity_z: {velocity_z:>10}"
                data_lines.append(line)
        return data_lines
